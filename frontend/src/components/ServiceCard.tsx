  ...
  return (
    <article className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-purple-500/5 border border-gray-100 hover:border-purple-200 transition-all group h-full flex flex-col">
      <div className="p-6 md:p-8 flex-grow">
        ...
        <p className="text-gray-500 mb-6 line-clamp-2 md:line-clamp-3 leading-relaxed text-sm md:text-base">
        ...
        <div className="flex justify-between items-center mt-auto">
          ...
          {showBookButton && (
            <Link 
              ...
              className="bg-purple-600 text-white px-5 py-2 md:px-6 md:py-2 rounded-xl font-bold hover:bg-purple-700 transition-all shadow-md hover:shadow-purple-500/20 active:scale-95 text-sm md:text-base"
            >
              Book Now
            </Link>
          )}
