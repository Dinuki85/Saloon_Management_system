...
export default function ServiceCard({ service, showBookButton = true }: { service: Service; showBookButton?: boolean }) {
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-purple-500/5 border border-gray-100 hover:border-purple-200 transition-all group h-full flex flex-col">
